...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function To(e,t,n){let r=new Float32Array(uo),i=new K(0,1,0);return new Hi({name:`SphericalGaussianBlur`,defines:{n:uo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Oo(),fragmentShader:`
	...
	`}var ko=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Yr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Tl.BlurDirectionX=new G(1,0),Tl.BlurDirectionY=new G(0,1);var El=new K;function Dl(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;El.copy(t),El[r]=0,El.normalize();let l=.5*o/(o+s),u=1-El.angleTo(e)/c;return Math.sign(El[n])===1?u*l:s/(o+s)+l+l*(1-u)}var Ol=class e extends ei{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new K,c=new K,l=new K(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new K,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=Dl(m,c,`z`,`y`,i,n),f[a+1]=1-Dl(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-Dl(m,c,`z`,`y`,i,n),f[a+1]=1-Dl(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-Dl(m,c,`x`,`z`,i,e),f[a+1]=Dl(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-Dl(m,c,`x`,`z`,i,e),f[a+1]=1-Dl(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-Dl(m,c,`x`,`y`,i,e),f[a+1]=1-Dl(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=Dl(m,c,`x`,`y`,i,e),f[a+1]=1-Dl(m,c,`y`,`x`,i,t);break}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}},kl=class extends fn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new ei;e.deleteAttribute(`uv`);let t=new Wi({side:1}),n=new Wi,r=new Ea(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new X(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new Br(e,n,6),o=new tn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new X(e,Al(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new X(e,Al(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new X(e,Al(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new X(e,Al(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new X(e,Al(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new X(e,Al(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function Al(e){return new Ki({color:0,emissive:16777215,emissiveIntensity:e})}var jl=document.querySelector(`#scene`),Ml=document.querySelector(`.experience`),Nl=document.querySelector(`.sticky-hero`),Pl=[...document.querySelectorAll(`[data-copy]`)],Fl=[...document.querySelectorAll(`[data-meter]`)],Il=document.querySelector(`#meter-fill`),Ll=document.querySelector(`#system-state`),Rl=document.querySelector(`.cursor-orbit`),zl=document.querySelector(`.menu-toggle`),Bl=document.querySelector(`.nav`),Vl=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;zl&&Bl&&(zl.addEventListener(`click`,()=>{let e=zl.getAttribute(`aria-expanded`)===`true`;zl.setAttribute(`aria-expanded`,String(!e)),Bl.classList.toggle(`is-open`,!e)}),Bl.addEventListener(`click`,e=>{e.target.closest(`a`)&&(zl.setAttribute(`aria-expanded`,`false`),Bl.classList.remove(`is-open`))}));var Hl=new pl({canvas:jl,antialias:!0,alpha:!1,powerPreference:`high-performance`});Hl.setPixelRatio(Math.min(window.devicePixelRatio,1.65)),Hl.setSize(window.innerWidth,window.innerHeight),Hl.outputColorSpace=Fe,Hl.toneMapping=4,Hl.toneMappingExposure=1.05,Hl.shadowMap.enabled=!0,Hl.shadowMap.type=2,Hl.setClearColor(526604,1);var Ul=new fn;Ul.background=new Y(526604),Ul.fog=new dn(526604,.038);var Wl=new wa(32,window.innerWidth/window.innerHeight,.1,100);Wl.position.set(.1,.15,12.4);var Gl=new bo(Hl),Kl=new kl;Ul.environment=Gl.fromScene(Kl,.03).texture,Kl.dispose(),Gl.dispose();var ql=new Sl(Hl);ql.addPass(new Cl(Ul,Wl));var Jl=new Tl(new G(window.innerWidth,window.innerHeight),.22,.45,.88);ql.addPass(Jl),Ul.add(new fa(13093586,1052950,1.05));var Yl=new ka(16118765,4.1);Yl.position.set(4,6,7),Yl.castShadow=!0,Yl.shadow.mapSize.set(2048,2048),Yl.shadow.camera.left=-8,Yl.shadow.camera.right=8,Yl.shadow.camera.top=8,Yl.shadow.camera.bottom=-8,Ul.add(Yl);var Xl=new Ea(8687800,18,18,2);Xl.position.set(-5,2.5,5),Ul.add(Xl);var Zl=new Ea(13488607,14,16,2);Zl.position.set(5,-2.5,3.5),Ul.add(Zl);var Ql=new Ea(10463172,8,12,2);Ql.position.set(2,2,6),Ul.add(Ql);var $l=new nn;$l.position.set(2.25,.15,0),$l.rotation.set(-.1,-.28,.03),Ul.add($l);var eu=new nn;$l.add(eu);var tu=new Gi({color:9277591,metalness:.95,roughness:.19,clearcoat:.75,clearcoatRoughness:.14,envMapIntensity:1.25}),nu=new Gi({color:1382172,metalness:.88,roughness:.22,clearcoat:.7,clearcoatRoughness:.16,envMapIntensity:1.15}),ru=new Gi({color:15855851,metalness:.08,roughness:.21,clearcoat:.88,clearcoatRoughness:.11}),iu=new Gi({color:7568799,metalness:.74,roughness:.2,clearcoat:.95,clearcoatRoughness:.1,emissive:1382953,emissiveIntensity:.22}),au=new Gi({color:921880,metalness:.62,roughness:.16,clearcoat:1,clearcoatRoughness:.1,envMapIntensity:1.2}),ou=new Gi({color:9147564,metalness:0,roughness:.05,transmission:.72,thickness:1.4,transparent:!0,opacity:.58,clearcoat:1,clearcoatRoughness:.04,ior:1.42,envMapIntensity:1.15}),su=new _r({color:10463429,transparent:!0,opacity:.5,toneMapped:!1}),cu=new _r({color:9016242,transparent:!0,opacity:.34,toneMapped:!1}),lu=new nn;eu.add(lu);var uu=new X(new Ol(3.55,2.45,.62,10,.22),ou);uu.castShadow=!0,uu.receiveShadow=!0,lu.add(uu);var du=new X(new Ol(2.85,1.78,.22,8,.14),au);du.position.z=.08,du.castShadow=!0,lu.add(du);var fu=new X(new Ol(2.35,1.28,.035,6,.1),iu);fu.position.z=.205,lu.add(fu);var pu=new nn;lu.add(pu);var mu=[];function hu(e,t,n,r,i){let a=new X(new Ol(e,t,n,6,.08),tu);return a.position.set(r,i,.05),a.castShadow=!0,pu.add(a),mu.push(a),a}hu(3.9,.18,.82,0,1.31),hu(3.9,.18,.82,0,-1.31),hu(.18,2.48,.82,-1.96,0),hu(.18,2.48,.82,1.96,0);var gu=new nn;du.add(gu),[[[-1.08,.42],[0,.42],[0,.08],[1.08,.08]],[[-1.08,.1],[-.42,.1],[-.42,-.48],[.7,-.48]],[[-.78,.65],[-.78,.2],[.78,.2],[.78,.62]],[[-.98,-.64],[-.2,-.64],[-.2,-.2],[1.02,-.2]]].forEach((e,t)=>{let n=new X(new Mi(new di(e.map(([e,t])=>new K(e,t,.14)),!1,`catmullrom`,.1),45,.014+t*.001,6,!1),cu.clone());gu.add(n)});var _u=[];for(let e=0;e<9;e++){let t=new X(new ti(.045,.045,.025,20),ru);t.rotation.x=Math.PI/2,t.position.set(-1.05+e%3*1.05,-.55+Math.floor(e/3)*.55,.16),gu.add(t),_u.push(t)}function vu(){let e=new nn,t=new Ol(.25,1.65,.18,5,.06),n=new X(t,ru);n.position.set(-.36,0,.34),n.rotation.z=-.46;let r=new X(t,iu);r.position.set(.36,0,.34),r.rotation.z=.46;let i=new X(new Ol(.74,.18,.18,5,.05),ru);return i.position.set(0,-.22,.34),e.add(n,r,i),e.scale.setScalar(.82),e}var yu=vu();lu.add(yu);var bu=new X(new ji(.88,.018,8,130),su);bu.position.z=.39,lu.add(bu);var xu=new nn;xu.position.z=-.5,lu.add(xu);var Su=[];[2.1,2.45,2.78].forEach((e,t)=>{let n=new X(new ji(e,.055-t*.01,14,180),t===1?iu:nu);n.rotation.set(Math.PI/2,0,t*.35),xu.add(n),Su.push(n)});for(let e=0;e<12;e++){let t=new X(new Ol(.12,.65,.28,4,.035),nu),n=e/12*Math.PI*2;t.position.set(Math.cos(n)*2.42,Math.sin(n)*2.42,-.05),t.rotation.z=n,t.rotation.y=.12,t.castShadow=!0,xu.add(t)}var Cu=[{name:`PRODUCT`,angle:.65},{name:`TEAM`,angle:2.3},{name:`TRANSFORM`,angle:3.85},{name:`CONSULT`,angle:5.45}],wu=[];function Tu(e){let t=document.createElement(`canvas`);t.width=512,t.height=170;let n=t.getContext(`2d`);n.clearRect(0,0,t.width,t.height),n.fillStyle=`#ecece7`,n.font=`600 28px Arial`,n.letterSpacing=`5px`,n.fillText(e,40,92),n.fillStyle=`#8992ad`,n.fillRect(40,116,120,3);let r=new Xr(t);return r.colorSpace=Fe,r}Cu.forEach((e,t)=>{let n=new nn,r=new X(new Ol(1.35,.62,.56,7,.11),nu);r.castShadow=!0,n.add(r);let i=new X(new Ol(.17,.64,.59,5,.06),tu);i.position.x=-.62,n.add(i);let a=new X(new ki(1,.32),new _r({map:Tu(e.name),transparent:!0,toneMapped:!1}));a.position.z=.286,n.add(a);let o=new X(new ti(.04,.04,.02,16),su.clone());o.rotation.x=Math.PI/2,o.position.set(.52,.18,.3),n.add(o);let s=3.55;n.userData.final=new K(Math.cos(e.angle)*s,Math.sin(e.angle)*s*.72,.25+t%2*-.45),n.userData.start=n.userData.final.clone().multiplyScalar(2.2).add(new K(0,0,-2.2)),n.userData.phase=t*1.4,eu.add(n),wu.push(n)});var Eu=[];wu.forEach((e,t)=>{let n=e.userData.final,r=new di([new K(0,0,-.32),n.clone().multiplyScalar(.35).add(new K(0,t%2?-.28:.28,-.2)),n.clone().multiplyScalar(.72),n.clone()]),i=new X(new Mi(r,90,.018,8,!1),cu.clone());i.material.opacity=.14,eu.add(i);let a=new X(new Ai(.045,16,12),su.clone());eu.add(a),Eu.push({tube:i,pulse:a,curve:r,offset:t*.23})});var Du=[];for(let e=0;e<7;e++){let t=new X(new Ol(3.02-e*.14,1.95-e*.1,.045,6,.1),new Gi({color:e%2?2238e3:7371155,metalness:e%2?.72:.52,roughness:.2,transparent:!0,opacity:.28-e*.018,clearcoat:.7}));t.position.z=-.25-e*.2,t.userData.assembledZ=t.position.z,t.userData.explodedZ=-1.8-e*.55,lu.add(t),Du.push(t)}var Ou=new X(new ki(35,22),new Ni({color:0,opacity:.34}));Ou.rotation.x=-Math.PI/2,Ou.position.y=-3.38,Ou.receiveShadow=!0,Ul.add(Ou);var ku=new X(new ti(2.8,3.1,.22,100),nu);ku.position.set(0,-3.23,-.5),ku.scale.y=.28,ku.receiveShadow=!0,ku.castShadow=!0,$l.add(ku);var Au=new X(new ji(2.55,.012,5,180),su.clone());Au.position.set(0,-3.12,-.5),Au.rotation.x=Math.PI/2,Au.material.opacity=.16,$l.add(Au);var ju=new G,Mu=new G,Nu=0,Pu=0,Fu=0,Iu=!0;function Lu(e,t=0,n=1){return Math.min(n,Math.max(t,e))}function Ru(e,t,n){let r=Lu((n-e)/(t-e));return r*r*(3-2*r)}function $(e,t,n){return e+(t-e)*n}function zu(e,t,n,r){e.position.set($(t.x,n.x,r),$(t.y,n.y,r),$(t.z,n.z,r))}var Bu=[`IDEA CORE ACTIVE`,`ARCHITECTURE ALIGNED`,`ENGINEERING ASSEMBLED`,`SYSTEM READY TO SCALE`];function Vu(e){Fu!==e&&(Fu=e,Pl.forEach((t,n)=>t.classList.toggle(`is-active`,n===e)),Fl.forEach((t,n)=>t.classList.toggle(`is-active`,n===e)),Ll.textContent=Bu[e])}function Hu(){let e=Ml.getBoundingClientRect(),t=Ml.offsetHeight-window.innerHeight;Nu=Lu(-e.top/Math.max(t,1))}window.addEventListener(`scroll`,Hu,{passive:!0}),Hu();function Uu(e){Mu.x=e.clientX/window.innerWidth*2-1,Mu.y=-(e.clientY/window.innerHeight)*2+1,Rl&&(Rl.style.transform=`translate3d(${e.clientX}px, ${e.clientY}px, 0)`),document.body.classList.add(`pointer-ready`)}window.addEventListener(`pointermove`,Uu,{passive:!0}),Nl.addEventListener(`pointerenter`,()=>document.body.classList.add(`pointer-active`)),Nl.addEventListener(`pointerleave`,()=>document.body.classList.remove(`pointer-active`)),document.addEventListener(`visibilitychange`,()=>{Iu=!document.hidden});function Wu(){let e=window.innerWidth;e<560?($l.position.set(.05,2.08,-1.6),$l.scale.setScalar(.57),Wl.fov=42):e<820?($l.position.set(.65,1.72,-1.1),$l.scale.setScalar(.68),Wl.fov=39):e<1150?($l.position.set(2.15,.32,-.4),$l.scale.setScalar(.82),Wl.fov=35):($l.position.set(2.35,.12,0),$l.scale.setScalar(1),Wl.fov=32),Wl.updateProjectionMatrix()}Wu(),window.addEventListener(`resize`,()=>{Hl.setSize(window.innerWidth,window.innerHeight),Hl.setPixelRatio(Math.min(window.devicePixelRatio,1.65)),ql.setSize(window.innerWidth,window.innerHeight),Wl.aspect=window.innerWidth/window.innerHeight,Wu(),Hu()});var Gu=new Ja;function Ku(){if(requestAnimationFrame(Ku),!Iu)return;let e=Math.min(Gu.getDelta(),.05),t=Gu.elapsedTime;Pu+=(Nu-Pu)*(Vl?1:.075),ju.lerp(Mu,.06),Vu(Math.min(3,Math.floor(Pu*4+.04))),Il.style.height=`${Pu*100}%`;let n=Ru(0,.13,Pu),r=Ru(.17,.42,Pu),i=Ru(.4,.72,Pu),a=Ru(.7,.98,Pu);uu.material.opacity=$(.18,.58,n),uu.scale.setScalar($(.72,1,n)),du.scale.setScalar($(.55,1,r)),du.rotation.z=$(-.28,0,r),du.position.z=$(-1.15,.08,r),fu.material.opacity=$(0,1,r),gu.visible=r>.04,gu.scale.setScalar($(.4,1,r)),gu.children.forEach((e,t)=>{e.material&&(e.material.opacity=$(0,t<4?.34:1,r))}),yu.scale.setScalar($(.2,.82,n)),yu.rotation.z=$(.42,0,n),bu.scale.setScalar($(.3,1,n)),bu.material.opacity=$(0,.48,n),mu.forEach((e,t)=>{let n=Lu((i-t*.08)/.72),r=t<2?new K(0,t===0?1.31:-1.31,.05):new K(t===2?-1.96:1.96,0,.05);zu(e,r.clone().multiplyScalar(2.25).add(new K(t%2?.8:-.8,t<2?t===0?1.2:-1.2:0,-1.7)),r,Ru(0,1,n)),e.rotation.z=$(t%2?.25:-.25,0,n)}),Du.forEach((e,t)=>{let n=Ru(.06+t*.055,.75+t*.025,i);e.position.z=$(e.userData.explodedZ,e.userData.assembledZ,n),e.rotation.z=$((t%2?1:-1)*.18,0,n),e.material.opacity=$(.04,.24-t*.015,n)}),xu.scale.setScalar($(.35,1,i)),xu.position.z=$(-3.8,-.5,i),Su.forEach((e,n)=>{e.rotation.z=(n%2?-1:1)*t*(.025+n*.008)+$(.8,0,i)}),wu.forEach((e,n)=>{let r=Ru(.02+n*.08,.64+n*.05,a);zu(e,e.userData.start,e.userData.final,r),e.rotation.set($(.5*(n%2?1:-1),.03*Math.sin(t*.45+e.userData.phase),r),$(-.7,Math.atan2(e.userData.final.x,5)*.3,r),$(.4,0,r)),e.scale.setScalar($(.4,1,r)),e.visible=r>.01}),Eu.forEach((e,n)=>{e.tube.material.opacity=$(0,.24,a);let r=(t*.07+e.offset)%1;e.pulse.position.copy(e.curve.getPointAt(r)),e.pulse.material.opacity=$(0,.7,a)*Math.sin(r*Math.PI),e.pulse.scale.setScalar(.6+Math.sin(r*Math.PI)*.7)}),eu.rotation.x=$(.28,-.06,r)+(Vl?0:ju.y*.055),eu.rotation.y=$(-.72,.32,i)+$(0,.36,a)+(Vl?0:ju.x*.09),eu.rotation.z=$(-.14,.015,n),eu.position.y=Math.sin(t*.45)*.035,eu.scale.setScalar($(.82,1.06,a));let o=window.innerWidth>=820,s=o?$(2.35,1.2,a):$l.position.x;o&&($l.position.x+=(s-$l.position.x)*.04),$l.rotation.y+=(-.28+(Vl?0:ju.x*.1)-$l.rotation.y)*.035,$l.rotation.x+=(-.1+(Vl?0:ju.y*.06)-$l.rotation.x)*.035;let c=$(12.4,10.65,a);Wl.position.z+=(c-Wl.position.z)*.035,Wl.position.x+=((Vl?0:ju.x*.22)+$(0,.65,a)-Wl.position.x)*.025,Wl.position.y+=((Vl?.15:.15+ju.y*.12)+$(0,-.08,a)-Wl.position.y)*.025,Wl.lookAt($(.55,1.1,a),.05,-.1),Ql.position.x+=(ju.x*5.5+1.2-Ql.position.x)*.05,Ql.position.y+=(ju.y*3.8+1-Ql.position.y)*.05,Au.material.opacity=.09+i*.1,Au.rotation.z+=e*.015,ql.render()}Vu(0),Ku();