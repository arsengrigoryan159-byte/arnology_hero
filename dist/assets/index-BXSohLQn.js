...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xo(e,t,n){let r=new Float32Array(Io),i=new K(0,1,0);return new pa({name:`SphericalGaussianBlur`,defines:{n:Io,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$o(),fragmentShader:`
	...
	`}var es=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new xi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Xl.BlurDirectionX=new G(1,0),Xl.BlurDirectionY=new G(0,1);var Zl=new K;function Ql(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;Zl.copy(t),Zl[r]=0,Zl.normalize();let l=.5*o/(o+s),u=1-Zl.angleTo(e)/c;return Math.sign(Zl[n])===1?u*l:s/(o+s)+l+l*(1-u)}var $l=class e extends Ei{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new K,c=new K,l=new K(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new K,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=Ql(m,c,`z`,`y`,i,n),f[a+1]=1-Ql(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-Ql(m,c,`z`,`y`,i,n),f[a+1]=1-Ql(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-Ql(m,c,`x`,`z`,i,e),f[a+1]=Ql(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-Ql(m,c,`x`,`z`,i,e),f[a+1]=1-Ql(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-Ql(m,c,`x`,`y`,i,e),f[a+1]=1-Ql(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=Ql(m,c,`x`,`y`,i,e),f[a+1]=1-Ql(m,c,`y`,`x`,i,t);break}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}},eu=class extends fn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new Ei;e.deleteAttribute(`uv`);let t=new ha({side:1}),n=new ha,r=new Za(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new X(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new ai(e,n,6),o=new tn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new X(e,tu(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new X(e,tu(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new X(e,tu(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new X(e,tu(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new X(e,tu(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new X(e,tu(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function tu(e){return new _a({color:0,emissive:16777215,emissiveIntensity:e})}var nu=document.querySelector(`#scene`),ru=document.querySelector(`.experience`),iu=document.querySelector(`.sticky-hero`),au=[...document.querySelectorAll(`[data-copy]`)],ou=[...document.querySelectorAll(`[data-meter]`)],su=document.querySelector(`#meter-fill`),cu=document.querySelector(`#system-state`),lu=document.querySelector(`.cursor-orbit`),uu=document.querySelector(`.menu-toggle`),du=document.querySelector(`.nav`),fu=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;uu&&du&&(uu.addEventListener(`click`,()=>{let e=uu.getAttribute(`aria-expanded`)===`true`;uu.setAttribute(`aria-expanded`,String(!e)),du.classList.toggle(`is-open`,!e)}),du.addEventListener(`click`,e=>{e.target.closest(`a`)&&(uu.setAttribute(`aria-expanded`,`false`),du.classList.remove(`is-open`))}));var pu=new Rl({canvas:nu,antialias:!0,alpha:!1,powerPreference:`high-performance`});pu.setPixelRatio(Math.min(window.devicePixelRatio,1.65)),pu.setSize(window.innerWidth,window.innerHeight),pu.outputColorSpace=Ie,pu.toneMapping=4,pu.toneMappingExposure=.94,pu.shadowMap.enabled=!1,pu.shadowMap.type=2,pu.setClearColor(0,1);var mu=new fn;mu.background=new Y(0),mu.fog=new dn(0,.026);var hu=new Ya(32,window.innerWidth/window.innerHeight,.1,100);hu.position.set(.1,.15,12.4);var gu=new Go(pu),_u=new eu;mu.environment=gu.fromScene(_u,.03).texture,_u.dispose(),gu.dispose();var vu=new ql(pu);vu.addPass(new Jl(mu,hu));var yu=new Xl(new G(window.innerWidth,window.innerHeight),.28,.52,.84);vu.addPass(yu),mu.add(new La(16777215,0,.72));var bu=new eo(16777215,3.4);bu.position.set(4,6,7),bu.castShadow=!0,bu.shadow.mapSize.set(2048,2048),bu.shadow.camera.left=-8,bu.shadow.camera.right=8,bu.shadow.camera.top=8,bu.shadow.camera.bottom=-8,mu.add(bu);var xu=new Za(3422037,14,20,2);xu.position.set(-5,2.5,5),mu.add(xu);var Su=new Za(15198183,10,18,2);Su.position.set(5,-2.5,3.5),mu.add(Su);var Cu=new Za(6251401,7,14,2);Cu.position.set(2,2,6),mu.add(Cu);var wu=new nn;wu.position.set(.75,.08,0),wu.rotation.set(-.04,-.12,.01),mu.add(wu);var Tu=new nn;wu.add(Tu);var Eu=new nn;wu.add(Eu);var Du=new ga({color:9079441,metalness:.96,roughness:.15,clearcoat:.84,clearcoatRoughness:.11,envMapIntensity:1.15}),Ou=new ga({color:460552,metalness:.91,roughness:.2,clearcoat:.7,clearcoatRoughness:.14}),ku=new Ir({color:3422037,transparent:!0,opacity:.72,toneMapped:!1,blending:2,depthWrite:!1}),Au=[];[{radius:3.15,tube:.032,material:Du},{radius:3.43,tube:.018,material:ku},{radius:3.68,tube:.027,material:Ou}].forEach((e,t)=>{let n=new X(new ra(e.radius,e.tube,18,280),e.material);n.rotation.z=t*.42,n.position.z=-.72-t*.11,Eu.add(n),Au.push(n)});var ju=[];[{radius:3.28,arc:Math.PI*.72,rotation:-.4},{radius:3.56,arc:Math.PI*.52,rotation:1.82},{radius:3.83,arc:Math.PI*.34,rotation:3.58}].forEach((e,t)=>{let n=new X(new ra(e.radius,.045-t*.008,14,180,e.arc),t===1?ku.clone():Du.clone());n.rotation.z=e.rotation,n.position.z=-.48+t*.08,Eu.add(n),ju.push(n)});function Mu(){let e=document.createElement(`canvas`);e.width=e.height=512;let t=e.getContext(`2d`),n=t.createRadialGradient(256,256,8,256,256,250);n.addColorStop(0,`rgba(90,94,145,.48)`),n.addColorStop(.26,`rgba(52,55,85,.20)`),n.addColorStop(1,`rgba(0,0,0,0)`),t.fillStyle=n,t.fillRect(0,0,512,512);let r=new Si(e);return r.colorSpace=Ie,r}var Nu=new Er(new fr({map:Mu(),transparent:!0,opacity:.72,blending:2,depthWrite:!1,toneMapped:!1}));Nu.scale.set(10.5,10.5,1),Nu.position.z=-1.35,Eu.add(Nu);var Pu=1050,Fu=new Float32Array(Pu*3);for(let e=0;e<Pu;e++){let t=4.1+Math.random()**.7*13,n=Math.random()*Math.PI*2,r=(Math.random()-.5)*10;Fu[e*3]=Math.cos(n)*t,Fu[e*3+1]=r,Fu[e*3+2]=-2.2-Math.random()*9}var Iu=new or;Iu.setAttribute(`position`,new Gn(Fu,3));var Lu=new yi(Iu,new mi({color:13027014,size:.022,transparent:!0,opacity:.42,sizeAttenuation:!0,depthWrite:!1}));mu.add(Lu);var Ru=360,zu=new Float32Array(Ru*3);for(let e=0;e<Ru;e++){let t=Math.random()*Math.PI*2,n=2.7+Math.random()*1.6;zu[e*3]=Math.cos(t)*n,zu[e*3+1]=Math.sin(t)*n*.95,zu[e*3+2]=-.25+(Math.random()-.5)*.55}var Bu=new or;Bu.setAttribute(`position`,new Gn(zu,3));var Vu=new yi(Bu,new mi({color:7830175,size:.035,transparent:!0,opacity:.52,blending:2,sizeAttenuation:!0,depthWrite:!1}));Eu.add(Vu);var Hu=new ga({color:10855848,metalness:.95,roughness:.19,clearcoat:.75,clearcoatRoughness:.14,envMapIntensity:1.25}),Uu=new ga({color:592139,metalness:.88,roughness:.22,clearcoat:.7,clearcoatRoughness:.16,envMapIntensity:1.15}),Wu=new ga({color:16053488,metalness:.08,roughness:.21,clearcoat:.88,clearcoatRoughness:.11}),Gu=new ga({color:3422037,metalness:.74,roughness:.2,clearcoat:.95,clearcoatRoughness:.1,emissive:723990,emissiveIntensity:.22}),Ku=new ga({color:328967,metalness:.62,roughness:.16,clearcoat:1,clearcoatRoughness:.1,envMapIntensity:1.2}),qu=new ga({color:3422037,metalness:0,roughness:.05,transmission:.72,thickness:1.4,transparent:!0,opacity:.58,clearcoat:1,clearcoatRoughness:.04,ior:1.42,envMapIntensity:1.15}),Ju=new Ir({color:7830175,transparent:!0,opacity:.44,toneMapped:!1}),Yu=new Ir({color:7830175,transparent:!0,opacity:.28,toneMapped:!1}),Xu=new nn;Tu.add(Xu);var Zu=new X(new $l(3.55,2.45,.62,10,.22),qu);Zu.castShadow=!0,Zu.receiveShadow=!0,Xu.add(Zu);var Qu=new X(new $l(2.85,1.78,.22,8,.14),Ku);Qu.position.z=.08,Qu.castShadow=!0,Xu.add(Qu);var $u=new X(new $l(2.35,1.28,.035,6,.1),Gu);$u.position.z=.205,Xu.add($u);var ed=new nn;Xu.add(ed);var td=[];function nd(e,t,n,r,i){let a=new X(new $l(e,t,n,6,.08),Hu);return a.position.set(r,i,.05),a.castShadow=!0,ed.add(a),td.push(a),a}nd(3.9,.18,.82,0,1.31),nd(3.9,.18,.82,0,-1.31),nd(.18,2.48,.82,-1.96,0),nd(.18,2.48,.82,1.96,0);var rd=new nn;Qu.add(rd),[[[-1.08,.42],[0,.42],[0,.08],[1.08,.08]],[[-1.08,.1],[-.42,.1],[-.42,-.48],[.7,-.48]],[[-.78,.65],[-.78,.2],[.78,.2],[.78,.62]],[[-.98,-.64],[-.2,-.64],[-.2,-.2],[1.02,-.2]]].forEach((e,t)=>{let n=new X(new ia(new Li(e.map(([e,t])=>new K(e,t,.14)),!1,`catmullrom`,.1),45,.014+t*.001,6,!1),Yu.clone());rd.add(n)});var id=[];for(let e=0;e<9;e++){let t=new X(new Di(.045,.045,.025,20),Wu);t.rotation.x=Math.PI/2,t.position.set(-1.05+e%3*1.05,-.55+Math.floor(e/3)*.55,.16),rd.add(t),id.push(t)}function ad(){let e=new nn,t=new $l(.25,1.65,.18,5,.06),n=new X(t,Wu);n.position.set(-.36,0,.34),n.rotation.z=-.46;let r=new X(t,Gu);r.position.set(.36,0,.34),r.rotation.z=.46;let i=new X(new $l(.74,.18,.18,5,.05),Wu);return i.position.set(0,-.22,.34),e.add(n,r,i),e.scale.setScalar(.82),e}var od=ad();Xu.add(od);var sd=new X(new ra(.88,.018,8,130),Ju);sd.position.z=.39,Xu.add(sd);var cd=new nn;cd.position.z=-.5,Xu.add(cd);var ld=[];[2.1,2.45,2.78].forEach((e,t)=>{let n=new X(new ra(e,.055-t*.01,14,180),t===1?Gu:Uu);n.rotation.set(Math.PI/2,0,t*.35),cd.add(n),ld.push(n)});for(let e=0;e<12;e++){let t=new X(new $l(.12,.65,.28,4,.035),Uu),n=e/12*Math.PI*2;t.position.set(Math.cos(n)*2.42,Math.sin(n)*2.42,-.05),t.rotation.z=n,t.rotation.y=.12,t.castShadow=!0,cd.add(t)}var ud=[{name:`PRODUCT`,angle:.65},{name:`TEAM`,angle:2.3},{name:`TRANSFORM`,angle:3.85},{name:`CONSULT`,angle:5.45}],dd=[];function fd(e){let t=document.createElement(`canvas`);t.width=512,t.height=170;let n=t.getContext(`2d`);n.clearRect(0,0,t.width,t.height),n.fillStyle=`#ecece7`,n.font=`600 28px Arial`,n.letterSpacing=`5px`,n.fillText(e,40,92),n.fillStyle=`#343755`,n.fillRect(40,116,120,3);let r=new Si(t);return r.colorSpace=Ie,r}ud.forEach((e,t)=>{let n=new nn,r=new X(new $l(1.35,.62,.56,7,.11),Uu);r.castShadow=!0,n.add(r);let i=new X(new $l(.17,.64,.59,5,.06),Hu);i.position.x=-.62,n.add(i);let a=new X(new ta(1,.32),new Ir({map:fd(e.name),transparent:!0,toneMapped:!1}));a.position.z=.286,n.add(a);let o=new X(new Di(.04,.04,.02,16),Ju.clone());o.rotation.x=Math.PI/2,o.position.set(.52,.18,.3),n.add(o);let s=3.55;n.userData.final=new K(Math.cos(e.angle)*s,Math.sin(e.angle)*s*.72,.25+t%2*-.45),n.userData.start=n.userData.final.clone().multiplyScalar(2.2).add(new K(0,0,-2.2)),n.userData.phase=t*1.4,Tu.add(n),dd.push(n)});var pd=[];dd.forEach((e,t)=>{let n=e.userData.final,r=new Li([new K(0,0,-.32),n.clone().multiplyScalar(.35).add(new K(0,t%2?-.28:.28,-.2)),n.clone().multiplyScalar(.72),n.clone()]),i=new X(new ia(r,90,.018,8,!1),Yu.clone());i.material.opacity=.14,Tu.add(i);let a=new X(new na(.045,16,12),Ju.clone());Tu.add(a),pd.push({tube:i,pulse:a,curve:r,offset:t*.23})});var md=[];for(let e=0;e<7;e++){let t=new X(new $l(3.02-e*.14,1.95-e*.1,.045,6,.1),new ga({color:e%2?855314:3422037,metalness:e%2?.72:.52,roughness:.2,transparent:!0,opacity:.28-e*.018,clearcoat:.7}));t.position.z=-.25-e*.2,t.userData.assembledZ=t.position.z,t.userData.explodedZ=-1.8-e*.55,Xu.add(t),md.push(t)}var hd=Au[1],gd=new G,_d=new G,vd=0,yd=0,bd=0,xd=!0;function Sd(e,t=0,n=1){return Math.min(n,Math.max(t,e))}function Cd(e,t,n){let r=Sd((n-e)/(t-e));return r*r*(3-2*r)}function $(e,t,n){return e+(t-e)*n}function wd(e,t,n,r){e.position.set($(t.x,n.x,r),$(t.y,n.y,r),$(t.z,n.z,r))}var Td=[`IDEA CORE ACTIVE`,`ARCHITECTURE ALIGNED`,`ENGINEERING ASSEMBLED`,`SYSTEM READY TO SCALE`];function Ed(e){bd!==e&&(bd=e,au.forEach((t,n)=>t.classList.toggle(`is-active`,n===e)),ou.forEach((t,n)=>t.classList.toggle(`is-active`,n===e)),cu.textContent=Td[e])}function Dd(){let e=ru.getBoundingClientRect(),t=ru.offsetHeight-window.innerHeight;vd=Sd(-e.top/Math.max(t,1))}window.addEventListener(`scroll`,Dd,{passive:!0}),Dd();function Od(e){_d.x=e.clientX/window.innerWidth*2-1,_d.y=-(e.clientY/window.innerHeight)*2+1,lu&&(lu.style.transform=`translate3d(${e.clientX}px, ${e.clientY}px, 0)`),document.body.classList.add(`pointer-ready`)}window.addEventListener(`pointermove`,Od,{passive:!0}),iu.addEventListener(`pointerenter`,()=>document.body.classList.add(`pointer-active`)),iu.addEventListener(`pointerleave`,()=>document.body.classList.remove(`pointer-active`)),document.addEventListener(`visibilitychange`,()=>{xd=!document.hidden});function kd(){let e=window.innerWidth;e<560?(wu.position.set(.08,1.62,-1.45),wu.scale.setScalar(.54),hu.fov=44):e<820?(wu.position.set(.18,1.32,-1),wu.scale.setScalar(.66),hu.fov=40):e<1150?(wu.position.set(.72,.2,-.45),wu.scale.setScalar(.82),hu.fov=35):(wu.position.set(.78,.06,0),wu.scale.setScalar(1),hu.fov=32),hu.updateProjectionMatrix()}kd(),window.addEventListener(`resize`,()=>{pu.setSize(window.innerWidth,window.innerHeight),pu.setPixelRatio(Math.min(window.devicePixelRatio,1.65)),vu.setSize(window.innerWidth,window.innerHeight),hu.aspect=window.innerWidth/window.innerHeight,kd(),Dd()});var Ad=new bo;function jd(){if(requestAnimationFrame(jd),!xd)return;let e=Math.min(Ad.getDelta(),.05),t=Ad.elapsedTime;yd+=(vd-yd)*(fu?1:.075),gd.lerp(_d,.06),Ed(Math.min(3,Math.floor(yd*4+.04))),su.style.height=`${yd*100}%`;let n=Cd(0,.13,yd),r=Cd(.17,.42,yd),i=Cd(.4,.72,yd),a=Cd(.7,.98,yd);Zu.material.opacity=$(.18,.58,n),Zu.scale.setScalar($(.72,1,n)),Qu.scale.setScalar($(.55,1,r)),Qu.rotation.z=$(-.28,0,r),Qu.position.z=$(-1.15,.08,r),$u.material.opacity=$(0,1,r),rd.visible=r>.04,rd.scale.setScalar($(.4,1,r)),rd.children.forEach((e,t)=>{e.material&&(e.material.opacity=$(0,t<4?.34:1,r))}),od.scale.setScalar($(.2,.82,n)),od.rotation.z=$(.42,0,n),sd.scale.setScalar($(.3,1,n)),sd.material.opacity=$(0,.48,n),td.forEach((e,t)=>{let n=Sd((i-t*.08)/.72),r=t<2?new K(0,t===0?1.31:-1.31,.05):new K(t===2?-1.96:1.96,0,.05);wd(e,r.clone().multiplyScalar(2.25).add(new K(t%2?.8:-.8,t<2?t===0?1.2:-1.2:0,-1.7)),r,Cd(0,1,n)),e.rotation.z=$(t%2?.25:-.25,0,n)}),md.forEach((e,t)=>{let n=Cd(.06+t*.055,.75+t*.025,i);e.position.z=$(e.userData.explodedZ,e.userData.assembledZ,n),e.rotation.z=$((t%2?1:-1)*.18,0,n),e.material.opacity=$(.04,.24-t*.015,n)}),cd.scale.setScalar($(.35,1,i)),cd.position.z=$(-3.8,-.5,i),ld.forEach((e,n)=>{e.rotation.z=(n%2?-1:1)*t*(.025+n*.008)+$(.8,0,i)}),dd.forEach((e,n)=>{let r=Cd(.02+n*.08,.64+n*.05,a);wd(e,e.userData.start,e.userData.final,r),e.rotation.set($(.5*(n%2?1:-1),.03*Math.sin(t*.45+e.userData.phase),r),$(-.7,Math.atan2(e.userData.final.x,5)*.3,r),$(.4,0,r)),e.scale.setScalar($(.4,1,r)),e.visible=r>.01}),pd.forEach((e,n)=>{e.tube.material.opacity=$(0,.24,a);let r=(t*.07+e.offset)%1;e.pulse.position.copy(e.curve.getPointAt(r)),e.pulse.material.opacity=$(0,.7,a)*Math.sin(r*Math.PI),e.pulse.scale.setScalar(.6+Math.sin(r*Math.PI)*.7)}),Tu.rotation.x=$(.16,-.035,r)+(fu?0:gd.y*.035),Tu.rotation.y=$(-.46,.2,i)+$(0,.24,a)+(fu?0:gd.x*.065),Tu.rotation.z=$(-.08,.008,n),Tu.position.y=Math.sin(t*.34)*.026,Tu.scale.setScalar($(.78,1.02,a));let o=window.innerWidth>=820,s=o?$(.82,.28,a):wu.position.x;o&&(wu.position.x+=(s-wu.position.x)*.035),wu.rotation.y+=(-.12+(fu?0:gd.x*.075)-wu.rotation.y)*.03,wu.rotation.x+=(-.04+(fu?0:gd.y*.045)-wu.rotation.x)*.03,Eu.rotation.z=t*.018+yd*.28,Eu.rotation.x=Math.sin(t*.17)*.018+(fu?0:gd.y*.02),Eu.rotation.y=Math.cos(t*.15)*.025+(fu?0:gd.x*.025),Au.forEach((t,n)=>{t.rotation.z+=e*(n%2?-.018:.012)*(1+a*.65)}),ju.forEach((t,r)=>{t.rotation.z+=e*(r%2?-.045:.032),t.material.opacity=$(.22,r===1?.74:.48,n)*(1-a*.08)}),Nu.material.opacity=$(.34,.78,n)+Math.sin(t*.42)*.035,Vu.rotation.z=-t*.026,Vu.material.opacity=$(.22,.58,n)+i*.08,Lu.rotation.y=t*.004,Lu.rotation.z=-t*.0025;let c=$(12.8,10.9,a);hu.position.z+=(c-hu.position.z)*.03,hu.position.x+=((fu?0:gd.x*.17)+$(0,.22,a)-hu.position.x)*.022,hu.position.y+=((fu?.1:.1+gd.y*.09)+$(0,-.05,a)-hu.position.y)*.022,hu.lookAt($(.2,.45,a),.02,-.25),Cu.position.x+=(gd.x*4.3+.8-Cu.position.x)*.045,Cu.position.y+=(gd.y*3.2+.8-Cu.position.y)*.045,hd.material.opacity=.42+i*.18,vu.render(),document.body.classList.contains(`is-ready`)||requestAnimationFrame(()=>requestAnimationFrame(()=>document.body.classList.add(`is-ready`)))}Ed(0),jd();